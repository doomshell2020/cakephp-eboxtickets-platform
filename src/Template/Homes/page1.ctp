        ...
        <div class="col-sm-3">
            <div class="sidebar">
                <ul class="list-unstyled components">
                    ...
                    <li class="active"> <a href="#" id="menu-group-dashboard"> <i class="bi bi-sliders"></i> Settings</a></li>
                    <li> <a href="#" id="menu-group-dashboard"> <i class="bi bi-ticket-perforated"></i> Tickets</a></li>
