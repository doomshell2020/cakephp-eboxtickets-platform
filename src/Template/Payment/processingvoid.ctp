...
<?php echo $this->Form->input('terminal_code',array('class'=>'form-control','placeholder'=>'TerminalCode','label' =>false,'readonly')); ?>
</div>
</div>
...
<?php echo $this->Form->input('terminal_serial_number',array('class'=>'form-control','placeholder'=>'TerminalSerialNumber','label' =>false,'readonly')); ?>
</div>
</div>
...
<div class="col-sm-6">
<div class="form-group">
<label>AutoReversal</label>
<?php echo $this->Form->input('auto_reversal',array('class'=>'form-control','placeholder'=>'AutoReversal','label' =>false,'required'=>true,'value'=>'false','readonly')); ?>
</div>
</div>
