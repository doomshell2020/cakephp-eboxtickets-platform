...
<?php echo $this->Form->input('transaction_identifier',array('class'=>'form-control','placeholder'=>'Transaction identifier','label' =>false,'required'=>true,'value'=>$transaction_identifier)); ?>
</div>
</div>
...
<div class="form-group">
<label>Other</label>
<?php echo $this->Form->input('other',array('class'=>'form-control','placeholder'=>'Other','label' =>false,'required'=>true,'value'=>'','readonly')); ?>
</div>
</div>
