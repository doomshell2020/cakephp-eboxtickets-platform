                                ...
                                <div class="row ">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="ticket_info">
                                            ...
                                            <h6>PURCHASER</h6>
                                            <p><?php echo $orderdetails['event']['company']['name']; ?> <?php //echo $orderdetails['order']['user']['name'] . ' ' . $orderdetails['order']['user']['lname']; ?></p>
                                            <h6>NAME</h6>
                                            <p><?php echo $orderdetails['ticketdetail'][0]['ticket_num']; ?></p>
                                        </div>
