...
if(count($ticketgen['ticketshare'])>0){
 $ticketimage = $ticketgen['ticketshare'][0]['qrcode'];
	
	 
 }else{
	$ticketimage = $ticketgen['qrcode'];
 }
...
<table style="width:100%" class="table table-bordered">
 <tr> 
<td rowspan="5" style="width:50%; border-left:2px solid #000; border-right:2px solid #000; border-bottom:2px solid #000; border-top:2px solid #000;">
<table width="100%">
<tr>
<td width="7%"></td>
...
<div>
<img src="http://flashticket.co-opselfservice.com/qrimages/temp/'.$ticketimage.'" style="max-width:100%; width:50px;">
</div>
</td>
<td width="7%"></td>
</tr>
...
echo $pdf->Output($ticketgen['ticket']['event']['name'].'.pdf');
exit;
?>
