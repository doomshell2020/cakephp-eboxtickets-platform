    ...
    <div class="card-body card-block">
      ...
      <div class="col-sm-6">
        <div class="form-group">
          ...
          <?php
          echo $this->Form->input('email', array('class' => 'longinput form-control input-medium', 'placeholder' => 'Organiser Email', 'type' => 'email', 'label' => false, 'id' => 'emailuser', 'data-val' => '0', 'required', 'autocomplete' => 'off')); ?>
        </div>
      ...
      <div class="col-sm-6">
        <div class="form-group">
          ...
          <?php
          echo $this->Form->input('mobile', array('class' => 'longinput form-control input-medium', 'placeholder' => 'Organiser Mobile Number', 'type' => 'text', 'label' => false, 'required', 'id' => 'addnum0', 'data-val' => '0', 'onkeypress' => 'return isNumber(event);', 'autocomplete' => 'off','maxLength'=>'10')); ?>
        </div>
