...
<!--<script src="http://code.jquery.com/ui/1.11.0/jquery-ui.js"></script>
  ...
  <div class="col-lg-12">
    <div class="card">
      <div class="card-header"><strong> <?php if(isset($event['id'])){ echo 'Edit Events'; }else{ echo 'Add Event';} ?></strong></div>
      ...
      echo $this->Form->input('event_org_id', array('class' => 'form-control longinput  input-medium','empty'=>'Select Organiser','options'=>$event_org_list,'required','label'=>false,'id'=>'sta','autocomplete'=>'off','value'=>$event['event_org_id'],'readonly','disabled')); ?>
       ...
       <?php if($event['feat_image']){ ?>
        <div class="col-sm-6">
          <div class="form-group">
            <img src="<?php echo SITE_URL;?>imagess/<?php echo $event['feat_image'];?>" height="70px" width="150px" style="display:block;">
          </div>
        </div>
      <?php } ?>
    ...
    <div class="col-sm-5">
          <div class="form-group">
            <label>Number of Seats</label>
             <?php
            echo $this->Form->input('no_of_seats', array('class' => 'longinput form-control input-medium numberseat','placeholder'=>'Number of Seats' ,'type'=>'text','label'=>false,'required' ,'autocomplete'=>'off','onkeypress'=>'return isNumberKey(event)','id'=>'seatsize')); ?>
 <span id="showmsgseatcheck" style="color:red;display:none">Not decrase the seats</span>
          </div>
        </div>
...
<div class="col-sm-12">
       ...
       <div class="col-sm-1">
        <?php if(isset($event['id'])){
          ...
          'class'=>array('btn btn-success'))); }else{  ?>
