    ...
    <div class="card-body card-block">
      ...
      <div class="col-sm-6">
        <div class="form-group">
          ...
          <?php
          echo $this->Form->input('name', array('class' => 'longinput form-control input-medium', 'placeholder' => 'Event Name', 'type' => 'text', 'label' => false, 'id' => 'dis', 'required', 'autocomplete' => 'off', 'pattern' => '.*[^ ].*')); ?>
        </div>
      </div>
      <div class="col-sm-6">
        <div class="form-group">
      ...
      <div class="col-sm-6">
        <div class="form-group">
          ...
          <span id="filesuplodmsg" style="color:red;">(Image height and width must 427*638)</span>
          <?php
      ...
      <div class="col-sm-6">
        <div class="form-group">
          ...
          <?php
          echo $this->Form->input('video_url', array('class' => 'longinput form-control input-medium', 'placeholder' => 'Enter youtube url', 'type' => 'url', 'label' => false, 'autocomplete' => 'off', 'onchange' => 'return Validateyoutubeurl()', 'id' => 'viourl', 'pattern' => '.*[^ ].*')); ?>
        </div>
      </div>
    ...
    if ((file = this.files[0])) {
      ...
      img.onload = function() {
        ...
        if (width >= maxwidth && height >= maxheight) {
          ...
          alert(`please upload Image height and width must 427*638`);
          return false;
        } else {
          return true;
        }
