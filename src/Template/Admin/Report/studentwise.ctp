                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Test Detail</strong>
...
<a href="#"><strong class=" btn btn-info card-title pull-right"> <i class="fa fa-file-excel-o"> Export CSV</i></strong></a>
                    ...
                    <div class="col-sm-2 anchrr">
                        <div class="form-group">
                            <label></label>
                    <?php $stats=array('1' =>'Pass' , '2'=>'fail' );
                    echo $this->Form->input('exam', array('class' => 'longinput form-control input-medium','options'=>$stats,'label'=>false, )); ?>
                        </div>
...
<thead>      
                ...
                <th scope="col"><?= $this->Paginator->sort('Test Date') ?></th>
                <th scope="col"><?= $this->Paginator->sort('Test Name') ?></th>
                <th scope="col"><?= $this->Paginator->sort('Test Center') ?></th>
                <th scope="col"><?= $this->Paginator->sort('Student Name') ?></th>
