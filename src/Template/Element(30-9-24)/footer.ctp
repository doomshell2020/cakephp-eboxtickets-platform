    ...
    <script src="<?php echo SITE_URL; ?>js/jquery-3.5.1.min.js" type="text/javascript" defer async></script>
    <script src="<?php echo SITE_URL; ?>js/moment.js" defer async></script>
    <script src="<?php echo SITE_URL; ?>js/moment-timezone-with-data-2012-2022.min.js" defer async></script>
    <!-- <script src="https://cdnjs.cloudflare.com/ajax/libs/flipclock/0.7.8/flipclock.js"></script> -->
    <script src="<?php echo SITE_URL; ?>js/flipclock.js" type="text/javascript" defer async></script>
    <script src="<?php echo SITE_URL; ?>js/bootstrap.min.js" type="text/javascript" defer async></script>

    <script src="<?php echo SITE_URL; ?>js/creditCardvalidater.js" type="text/javascript" defer async></script>
    <script src="<?php echo SITE_URL; ?>js/owl.carousel.min.js" type="text/javascript" defer async></script>
    <script src="<?php echo SITE_URL; ?>js/wow.min.js" type="text/javascript" defer async></script>
    <script src="<?php echo SITE_URL; ?>js/semantic.min.js" defer async></script>
    <link href="<?php echo SITE_URL; ?>css/semantic.min.css" rel="stylesheet" type="text/css" />
    <script src="<?php echo SITE_URL; ?>js/summernote-bs4.js" defer async></script>
