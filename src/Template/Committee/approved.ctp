                    ...
                    <div class="ignored_ditals">
                        ...
                        ?>
                            ...
                            <div class="row item_list align-items-center mb-3">
                                ...
                                <div class="col-4">
                                    <h6 class="padding_itams"><?php echo $value['user']['name']; ?></h6>
                                ...
                                <div class="col-3">
                                    <a class="btn cancel_c btn-sm btn approvalrequest"
                                        href="<?php echo SITE_URL; ?>committee/completepayment/<?php echo $value['id']; ?>"
                                        onclick="javascript: return confirm('Kindly confirm Cash Payment Received for this Ticket?')">Cash
                                        Payment</a>
                                    <a class="btn cancel_d btn-sm btn"
                                        href="<?php echo SITE_URL; ?>committee/issuecommittee/<?php echo $value['id']; ?>"
                                        onclick="javascript: return confirm('Are you sure you want to Issue this Complimentary?')">Issue
                                        Complimentary</a>
                                </div>
...
<!-- <script>
    $(document).on('click', '.approvalrequest', function(e) {
        $('#approvalrequest').modal('show').find('.modal-body').html('<h6 style="color:red;">Loading....Please Wait</h6>');
        e.preventDefault();
