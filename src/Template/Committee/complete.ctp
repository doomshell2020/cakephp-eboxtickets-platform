                    ...
                    <div class="ignored_ditals">
                        <div class="container-fluid">
                            <div class="row item_heading2">
                                ...
                                <div class="col-6">Ticket</div>
                                <div class="col-0"></div>
                            </div>
                            <?php
                            if (!empty($cart_data_complete)) {
                                foreach ($cart_data_complete as $key => $value) { //pr($value);die;
                            ...
                            ?>
                                    <div class="row item_list align-items-center">
                                        <div class="col-2">
                                            <img class="event_img" src="<?php echo IMAGE_PATH . 'Usersprofile/' . $profile_image; ?>" alt="profile">
                                        </div>
                                        <div class="col-4">
                                        ...
                                        <div class="col-6">
                                            ...
                                            <!-- <p> $150.00 USD</p> -->
                                            <h6><?php echo $value['event']['currency']['Currency_symbol']; ?><?php echo sprintf('%0.2f', $value['eventdetail']['price']); ?>
                                                <?php echo $value['event']['currency']['Currency'] . ' (' . ucwords($value['order']['paymenttype']) . ')'; ?>
                                            </h6>
                                            <p>Date:-<?php echo date('d-m-Y', strtotime($value['created'])); ?></p>

                                            <?php if (!empty($value['user_desc'])) { ?>
                                            ...
                                            <?php if (!empty($value['user_desc'])) { ?>
                                                ...
                                                <button type="button" class="btn e-mail-btn_A " data-bs-toggle="modal" data-bs-target="#staticBackdrop<?php echo $value['id']; ?>">
                                                    <i class="bi bi-envelope"></i>
                                                </button>
                                                <!-- Modal -->
                                                <div class="modal fade" id="staticBackdrop<?php echo $value['id']; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
